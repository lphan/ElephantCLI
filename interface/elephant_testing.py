...
class Elephant_sub(object):
    ...
    def suite():
        ...
        suite.addTest(test_statistics.suite())
        suite.addTest(test_statistics.suite2())
        # suite.addTest(test_neo_tools.suite())
        return suite

    @staticmethod
    def test_elephant_module():
        unittest.TextTestRunner(verbosity=2).run(Elephant_sub.suite())
